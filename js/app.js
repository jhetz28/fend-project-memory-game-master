...
let cardsArray = ['fa-anchor', 'fa-bicycle', 'fa-bolt', 'fa-cube','fa-diamond', 'fa-plane', 'fa-leaf', 'fa-bomb'];
newArray = cardsArray.concat(cardsArray);
...
function closeUnmatchedCards() {
    ...
    Array.from(els).forEach(el => {
        el.classList.remove('unMatch', 'show', 'open');
    });
}
...
function gameStart() {
    ...
    let cardsShuffled = shuffle(newArray);
